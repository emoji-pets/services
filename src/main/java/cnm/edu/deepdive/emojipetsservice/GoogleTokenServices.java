  ...
  public OAuth2Authentication loadAuthentication(String idTokenString)
    ...
    try {
      ...
      if (idToken != null) {
        ...
        Collection<GrantedAuthority> grants = Collections.singleton(new SimpleGrantedAuthority("ROLE_USER"));
        Authentication base = new UsernamePasswordAuthenticationToken(payload.getSubject(), idTokenString, grants);
